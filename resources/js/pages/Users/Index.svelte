...
<DashboardLayout
    ...
    actions={canCreate
        ? [{ label: 'Create User', href: '/users/create', variant: 'primary' }]
        : []}
    cards={stats}
>
    <!-- Search bar -->
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                {#if user.email_verified_at}
                                    <span
                                        class="inline-flex items-center gap-1.5 rounded-full bg-green-50 px-3 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20 dark:bg-green-950 dark:text-green-400 dark:ring-green-400/20"
                                    >
                                        <span
                                ...
                                {:else}
                                    <span
                                        class="inline-flex items-center gap-1.5 rounded-full bg-yellow-50 px-3 py-1 text-xs font-medium text-yellow-700 ring-1 ring-inset ring-yellow-600/20 dark:bg-yellow-950 dark:text-yellow-400 dark:ring-yellow-400/20"
                                    >
                                        <span
...
<DeleteConfirmModal
    ...
    title="Delete User"
    message="This will permanently remove this user and all associated data."
